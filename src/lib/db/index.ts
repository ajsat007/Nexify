...
function autoSeed(db: Database.Database): void {
  ...
  const projects = [
    ...
    { id: 'PRJ-003', name: 'E-commerce Recommendation Engine', client: 'StyleCart', description: 'AI recommendation system', value: 500000, status: 'active', progress: 92, deadline: '2026-07-10', github_repo: '', github_url: '', tech_stack: '["Python","TensorFlow","Redis","FastAPI"]', agent_ids: '["ai-theta","data-zeta"]', created_at: '2026-04-20T00:00:00Z', updated_at: '2026-07-09T00:00:00Z' },
    { id: 'PRJ-004', name: 'EdTech Learning Platform', client: 'EduVista', description: 'Online learning management system', value: 800000, status: 'active', progress: 30, deadline: '2026-09-15', github_repo: '', github_url: '', tech_stack: '["Next.js","Node.js","PostgreSQL","AWS"]', agent_ids: '["frontend-lambda","dev-beta","design-gamma"]', created_at: '2026-06-01T00:00:00Z', updated_at: '2026-07-10T00:00:00Z' },
    { id: 'PRJ-005', name: 'Logistics Fleet Management', client: 'LogiMove', description: 'Fleet tracking system', value: 750000, status: 'planning', progress: 10, deadline: '2026-10-01', github_repo: '', github_url: '', tech_stack: '["React","Python","PostgreSQL","IoT"]', agent_ids: '["devops-epsilon","data-zeta"]', created_at: '2026-06-20T00:00:00Z', updated_at: '2026-07-01T00:00:00Z' },
    { id: 'PRJ-006', name: 'AI Customer Support Chatbot', client: 'SupportPro', description: 'Multi-channel support chatbot', value: 300000, status: 'active', progress: 65, deadline: '2026-08-01', github_repo: '', github_url: '', tech_stack: '["Python","LangChain","OpenAI","WhatsApp API"]', agent_ids: '["bot-kappa","ai-theta"]', created_at: '2026-05-10T00:00:00Z', updated_at: '2026-07-10T00:00:00Z' },
    { id: 'PRJ-007', name: 'Retail Analytics Dashboard', client: 'RetailMax', description: 'Retail analytics', value: 350000, status: 'completed', progress: 100, deadline: '2026-06-30', github_repo: '', github_url: '', tech_stack: '["React","Python","PostgreSQL","Metabase"]', agent_ids: '["data-zeta","frontend-lambda"]', created_at: '2026-03-15T00:00:00Z', updated_at: '2026-06-30T00:00:00Z' },
    { id: 'PRJ-008', name: 'HRMS & Payroll System', client: 'EnterpriseCorp', description: 'HR management system', value: 600000, status: 'planning', progress: 5, deadline: '2026-10-15', github_repo: '', github_url: '', tech_stack: '["Next.js","Node.js","PostgreSQL","AWS"]', agent_ids: '["dev-alpha","frontend-lambda"]', created_at: '2026-07-01T00:00:00Z', updated_at: '2026-07-05T00:00:00Z' },
  ]
