            ...
            {automations.map((a, i) => (
              <div key={i} className="bg-neutral-50 rounded-2xl p-6 border border-neutral-200 hover:shadow-lg hover:border-primary-500/20 transition-all">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="flex items-center gap-1 text-xs text-neutral-400"><RefreshCw size={12} /> {a.time}</div>
                </div>
                <div className="text-xs text-neutral-400 mb-2">Trigger: {a.trigger}</div>
