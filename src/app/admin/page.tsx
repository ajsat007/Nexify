    ...
    <div className="min-h-screen bg-neutral-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-neutral-800 rounded-2xl p-8 border border-neutral-700">
          ...
          <p className="text-center text-neutral-500 text-xs mt-4">Demo: click to enter</p>
        </div>
      </div>
    </div>
  )
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-neutral-400 text-sm">AI company operational overview — all metrics AI-generated.</p>
        </div>
            ...
            {agents.slice(0, 6).map(a => (
              <div key={a.id} className="flex items-center gap-4 p-3 rounded-xl hover:bg-neutral-50 transition-all">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs text-neutral-400">{a.specialization} · {a.tasksCompleted} tasks</div>
                </div>
            ...
            {leads.slice(0, 5).map(l => (
              <div key={l.id} className="flex items-start gap-3 p-2.5 rounded-xl hover:bg-neutral-50 transition-all">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="text-xs text-neutral-400">{l.service} · {l.value}</div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {projects.filter(p => p.status !== 'completed').slice(0, 4).map(p => (
            <div key={p.id} className="p-4 rounded-xl bg-neutral-50 border border-neutral-100">
              ...
              <div className="text-xs text-neutral-400 mb-2">{p.client} · {p.value}</div>
              <ProgressBar value={p.progress} />
              <div className="text-xs text-neutral-400 mt-1">{p.progress}% complete</div>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-neutral-200 p-5">
        ...
        <div className="grid sm:grid-cols-4 gap-6">
          <div className="text-center p-4">
            ...
            <div className="text-xs text-neutral-400 mt-1">Avg Efficiency</div>
          </div>
          <div className="text-center p-4">
            <div className="text-3xl font-heading font-bold gradient-text">99.95%</div>
            <div className="text-xs text-neutral-400 mt-1">Avg Uptime</div>
          </div>
          <div className="text-center p-4">
            <div className="text-3xl font-heading font-bold gradient-text">6,264</div>
            <div className="text-xs text-neutral-400 mt-1">Tasks Completed (June)</div>
          </div>
          <div className="text-center p-4">
            <div className="text-3xl font-heading font-bold gradient-text">₹0</div>
            <div className="text-xs text-neutral-400 mt-1">Labor Cost (AI)</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-neutral-400 text-sm">12 agents deployed · 0 labor cost · 99.95% avg uptime</p>
        </div>
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-neutral-400">{a.type} · {a.model}</div>
                </div>
              </div>
              <button className="text-neutral-400 hover:text-neutral-600"><MoreHorizontal size={16} /></button>
            </div>
            <div className="grid grid-cols-3 gap-4 text-center text-sm mb-4">
              <div><div className="font-semibold text-neutral-900">{a.projects}</div><div className="text-xs text-neutral-400">Projects</div></div>
              <div><div className="font-semibold text-neutral-900">{a.tasksCompleted}</div><div className="text-xs text-neutral-400">Tasks</div></div>
              <div><div className="font-semibold text-neutral-900">{a.efficiency}%</div><div className="text-xs text-neutral-400">Efficiency</div></div>
            </div>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-neutral-400 text-sm">8 active projects · ₹49.5L total value</p>
        </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-neutral-100 bg-neutral-50">
                <th className="text-left p-4 text-xs font-semibold text-neutral-400 uppercase">Project</th>
                <th className="text-left p-4 text-xs font-semibold text-neutral-400 uppercase">Client</th>
                <th className="text-left p-4 text-xs font-semibold text-neutral-400 uppercase">Value</th>
                <th className="text-left p-4 text-xs font-semibold text-neutral-400 uppercase">Progress</th>
                <th className="text-left p-4 text-xs font-semibold text-neutral-400 uppercase">Agents</th>
                <th className="text-left p-4 text-xs font-semibold text-neutral-400 uppercase">Deadline</th>
                <th className="text-left p-4 text-xs font-semibold text-neutral-400 uppercase">Status</th>
                <th className="text-right p-4 text-xs font-semibold text-neutral-400 uppercase">Action</th>
              </tr>
            </thead>
              ...
              {projects.map(p => {
                ...
                return (
                  <tr key={p.id} className="hover:bg-neutral-50 transition-all">
                    ...
                    <td className="p-4 text-sm text-neutral-500">{p.client}</td>
                    ...
                    <td className="p-4">
                      <div className="flex -space-x-2">
                        ...
                        {assigned.length > 3 && <div className="w-7 h-7 rounded-full bg-neutral-100 border-2 border-white flex items-center justify-center text-[8px] text-neutral-400 font-bold">+{assigned.length - 3}</div>}
                      </div>
                    </td>
                    <td className="p-4 text-sm text-neutral-500">{p.deadline}</td>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-neutral-400 text-sm">8 leads in pipeline · AI-powered lead scoring</p>
        </div>
      ...
      <div className="grid grid-cols-4 gap-4">
        {Object.entries(funnel).map(([k, v]) => (
          <div key={k} className="text-center p-4 bg-white rounded-xl border border-neutral-200">
            ...
            <div className="text-xs text-neutral-400 capitalize">{k}</div>
          </div>
        ))}
      </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-neutral-400">{l.contact} · {l.email}</div>
                  <div className="text-xs text-neutral-400 mt-1">{l.service} · {l.value} · Source: {l.source}</div>
                </div>
              </div>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-neutral-400 text-sm">Zero labor cost · 100% margin on services</p>
        </div>
      ...
      <div className="bg-white rounded-xl border border-neutral-200 p-5">
        ...
        <p className="text-center text-xs text-neutral-400 mt-2">Traditional agency margin: 15-25% · Nexify AI advantage: zero labor, zero overhead</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-neutral-200 overflow-hidden">
        ...
        <div className="overflow-x-auto mt-2">
          <table className="w-full">
            <thead>
              <tr className="border-b border-neutral-100 bg-neutral-50">
                <th className="text-left p-4 text-xs font-semibold text-neutral-400 uppercase">Description</th>
                <th className="text-left p-4 text-xs font-semibold text-neutral-400 uppercase">Category</th>
                <th className="text-left p-4 text-xs font-semibold text-neutral-400 uppercase">Amount</th>
                <th className="text-left p-4 text-xs font-semibold text-neutral-400 uppercase">Date</th>
                <th className="text-left p-4 text-xs font-semibold text-neutral-400 uppercase">Type</th>
                <th className="text-left p-4 text-xs font-semibold text-neutral-400 uppercase">Status</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-neutral-100">
              {transactions.map(t => (
                <tr key={t.id} className="hover:bg-neutral-50 transition-all">
                  ...
                  <td className="p-4 text-sm text-neutral-500">{t.category}</td>
                  ...
                  <td className="p-4 text-sm text-neutral-500">{t.date}</td>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-neutral-400 text-sm">AI agents work 24/7/365 · No leaves · No holidays</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-neutral-200 overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
              <tr className="border-b border-neutral-100 bg-neutral-50">
                <th className="text-left p-4 text-xs font-semibold text-neutral-400 uppercase">Agent</th>
                <th className="text-left p-4 text-xs font-semibold text-neutral-400 uppercase">Date</th>
                <th className="text-left p-4 text-xs font-semibold text-neutral-400 uppercase">Status</th>
                <th className="text-left p-4 text-xs font-semibold text-neutral-400 uppercase">Active Hours</th>
                <th className="text-left p-4 text-xs font-semibold text-neutral-400 uppercase">Tasks Done</th>
                <th className="text-left p-4 text-xs font-semibold text-neutral-400 uppercase">Efficiency</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-neutral-100">
              {attendance.map(a => {
                ...
                return (
                  <tr key={a.id} className="hover:bg-neutral-50">
                    ...
                    <td className="p-4 text-sm text-neutral-500">{a.date}</td>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-neutral-400 text-sm">All digital assets managed · Zero physical inventory</p>
        </div>
      </div>
            ...
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-3">
                <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${a.type === 'LLM Model' ? 'bg-accent-50' : a.type === 'Cloud' ? 'bg-primary-50' : a.type === 'Infra' ? 'bg-success/10' : 'bg-neutral-100'}`}>
                  {a.type === 'LLM Model' ? <Brain className="w-5 h-5 text-accent-500" /> : a.type === 'Cloud' ? <Server className="w-5 h-5 text-primary-500" /> : a.type === 'Infra' ? <Database className="w-5 h-5 text-success" /> : <Monitor className="w-5 h-5 text-neutral-500" />}
                </div>
                <div>
                  <div className="font-semibold text-sm text-neutral-900">{a.name}</div>
                  <div className="text-xs text-neutral-400">{a.type} · Assigned: {a.assignedTo}</div>
                </div>
              </div>
              <Badge status={a.status} />
            </div>
            <div className="mt-3 text-xs text-neutral-400">Expiry: {a.expiry}</div>
          </div>
        ))}
      </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {(DB.get('inventory') || []).map((i: any) => (
            <div key={i.id} className="p-4 rounded-xl bg-neutral-50 border border-neutral-100">
              ...
              <div className="text-xs text-neutral-400 mt-1">{i.used.toLocaleString()} / {i.total.toLocaleString()} {i.unit} used</div>
            </div>
          ))}
        </div>
      </div>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-neutral-400 text-sm">AI-generated insights · 100% data accuracy</p>
        </div>
        ...
        <div className="space-y-3">
          {perf.map(p => (
            <div key={p.month} className="flex items-center gap-4">
              <span className="text-xs text-neutral-400 w-8">{p.month}</span>
              ...
              <span className="text-xs text-neutral-500 w-16 text-right">{p.tasks}</span>
        ...
        <div className="space-y-2">
          {agents.sort((a, b) => b.efficiency - a.efficiency).map((a, i) => (
            <div key={a.id} className="flex items-center gap-4 p-3 rounded-xl hover:bg-neutral-50">
              <span className={`w-6 h-6 rounded-lg flex items-center justify-center text-xs font-bold ${i === 0 ? 'bg-warning/20 text-warning' : 'bg-neutral-100 text-neutral-500'}`}>{i + 1}</span>
              <div className="flex-1 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4 text-xs">
                  <span className="text-neutral-400">{a.tasksCompleted} tasks</span>
      ...
      <div className="grid sm:grid-cols-3 gap-4">
        <div className="bg-white rounded-xl border border-neutral-200 p-5 text-center">
          ...
          <div className="text-xs text-neutral-400 mt-1">System Uptime (30 days)</div>
        </div>
        <div className="bg-white rounded-xl border border-neutral-200 p-5 text-center">
          <div className="text-2xl font-heading font-bold gradient-text">0</div>
          <div className="text-xs text-neutral-400 mt-1">Human Errors (30 days)</div>
        </div>
        <div className="bg-white rounded-xl border border-neutral-200 p-5 text-center">
          <div className="text-2xl font-heading font-bold gradient-text">₹0</div>
          <div className="text-xs text-neutral-400 mt-1">Labor Cost (All time)</div>
        </div>
      </div>
    </div>
  )
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-neutral-400 text-sm">6 roles defined · RBAC enforced</p>
        </div>
            ...
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-neutral-400">{r.agents} agent{r.agents > 1 ? 's' : ''}</div>
                </div>
              </div>
            </div>
            <div className="flex flex-wrap gap-1.5 mt-2">
              {r.permissions.map((p: string) => (
                <span key={p} className="chip bg-neutral-100 text-neutral-500 text-[10px]">{p.replace('_', ' ')}</span>
              ))}
            </div>
          </div>
        ))}
      ...
      <aside className={`fixed lg:sticky top-0 left-0 h-full w-64 bg-neutral-900 border-r border-neutral-800 z-40 transform transition-transform duration-300 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}>
        <div className="p-6 border-b border-neutral-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-neutral-500 text-xs">Management Console</p>
            </div>
          </div>
        </div>
        <nav className="p-4 space-y-1">
          {tabs.map(tab => (
            <button key={tab.id} onClick={() => { setActiveTab(tab.id); setSidebarOpen(false) }}
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all ${activeTab === tab.id ? 'bg-primary-500/10 text-primary-400 border border-primary-500/20' : 'text-neutral-400 hover:bg-neutral-800 hover:text-neutral-200'}`}>
              <tab.icon size={18} />
              <span>{tab.label}</span>
            </button>
          ))}
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-neutral-800">
          <div className="flex items-center gap-3 px-4 py-3">
            ...
            <button onClick={() => setAuthenticated(false)} className="text-neutral-500 hover:text-error transition-all"><LogOut size={16} /></button>
          </div>
        </div>
      </aside>
        ...
        <div className="sticky top-0 bg-white/80 backdrop-blur-xl border-b border-neutral-200 z-20">
          <div className="flex items-center justify-between px-4 sm:px-6 py-4">
            ...
            <div className="flex items-center gap-3 ml-auto">
              <Link href="/" className="text-xs text-neutral-400 hover:text-primary-500 flex items-center gap-1"><Home size={12} /> Main Site</Link>
              <Link href="/portal" className="text-xs text-neutral-400 hover:text-primary-500 flex items-center gap-1"><ExternalLink size={12} /> Client Portal</Link>
