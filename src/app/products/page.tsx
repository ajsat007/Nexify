            ...
            {products.map((p, i) => {
              ...
              return (
                <Link key={p.id} href={`#${p.id}`} className="bg-neutral-50 rounded-xl p-4 border border-neutral-200 hover:border-primary-500/30 hover:bg-white transition-all text-center group">
                  ...
                  <div className="text-xs text-neutral-400 mt-1">{p.price}</div>
                </Link>
              )
            })}
          </div>
                  ...
                  <div className="grid lg:grid-cols-5 gap-12">
                    ...
                    <div className="lg:col-span-3">
                      <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                          ...
                          <p className="text-neutral-400 italic">{product.tagline}</p>
                        </div>
                      </div>
                      <p className="text-neutral-500 mb-8 leading-relaxed text-lg">{product.description}</p>
                      ...
                      <div className="flex flex-wrap gap-6">
                        <div>
                          <h4 className="text-xs uppercase tracking-wider text-neutral-400 font-semibold mb-2">Tech Stack</h4>
                        ...
                        <div>
                          <h4 className="text-xs uppercase tracking-wider text-neutral-400 font-semibold mb-2">User Roles</h4>
                          <div className="flex flex-wrap gap-2">
                    ...
                    <div className="lg:col-span-2">
                      <div className="bg-neutral-50 rounded-2xl p-6 border border-neutral-200 sticky top-28">
                        <div className="text-sm text-neutral-400 mb-1">Starting from</div>
