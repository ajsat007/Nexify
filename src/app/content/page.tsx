        ...
        <div className="section-container">
          ...
          <div className="card-surface p-8 mb-12 reveal">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div><h2 className="text-2xl font-heading font-bold">AI Content Generator</h2><p className="text-sm text-neutral-400">Generates LinkedIn/Twitter posts optimized for engagement</p></div>
            </div>
              ...
              <div className="animate-slide-up space-y-4" ref={bottomRef as any}>
                <div className={`p-6 rounded-xl border ${selectedPlatform === 'LinkedIn' ? 'bg-blue-50 dark:bg-blue-500/5 border-blue-200 dark:border-blue-500/20' : 'bg-neutral-50 dark:bg-neutral-800/50 border-neutral-200 dark:border-neutral-700'}`}>
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="text-xs font-medium text-neutral-400 uppercase">{selectedPlatform} · {selectedType.replace('-', ' ')}</span>
                  </div>
          ...
          {analytics.topPost && (
            <div className="bg-gradient-to-r from-amber-500/5 to-orange-500/5 rounded-2xl border border-amber-500/20 p-6 mb-12 reveal">
              ...
              <p className="text-sm text-neutral-500">{analytics.topPost}</p>
            </div>
          )}
          ...
          <div className="space-y-4 reveal">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs text-neutral-400">{posts.length} posts generated</span>
            </div>
            {posts.map((post, i) => (
          ...
          <div className="mt-12 bg-gradient-to-r from-primary-500/5 to-accent-500/5 rounded-2xl border border-primary-500/20 p-8 text-center reveal">
            ...
            <p className="text-neutral-500 mb-6 max-w-md mx-auto">AI generates posts, schedules them, and tracks engagement. Build your audience without lifting a finger.</p>
