        ...
        <div className="section-container">
          <div className="grid lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-3">
              {submitted ? (
                <div className="bg-success/5 rounded-2xl border border-success/20 p-8 sm:p-12 text-center">
                  ...
                  <p className="text-surface-700 dark:text-surface-400 text-sm sm:text-base max-w-md mx-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                  ...
                  <p className="text-sm text-surface-600 mb-4">All fields marked with * are required.</p>
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-1.5">Service Needed</label>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-1.5">Project Details *</label>
            ...
            <div className="lg:col-span-2 space-y-4 sm:space-y-6">
              {/* What happens next */}
              <div className="bg-surface-50 dark:bg-surface-800 rounded-2xl p-5 sm:p-8 border border-surface-200 dark:border-surface-700">
                ...
                <ol className="space-y-3">
                  {[
                    ...
                    <li key={i} className="flex items-center gap-3 text-sm text-surface-700 dark:text-surface-400">
                      ...
                      <span className="text-xs text-surface-500 flex items-center gap-1"><Clock size={11} /> {s.time}</span>
                    </li>
                  ))}
                </ol>
              </div>
              ...
              {/* Contact info */}
              <div className="bg-surface-50 dark:bg-surface-800 rounded-2xl p-5 sm:p-8 border border-surface-200 dark:border-surface-700 space-y-4">
                <h3 className="font-semibold dark:text-white text-sm">Reach Us Directly</h3>
                <div className="space-y-3">
                  <a href="mailto:ajinkyasatkar5@gmail.com" className="flex items-center gap-3 text-sm text-surface-700 dark:text-surface-400 hover:text-primary-500 transition-colors">
                    <Mail size={16} className="text-primary-500 shrink-0" />
                    ajinkyasatkar5@gmail.com
                  </a>
                  <a href="tel:+919373955349" className="flex items-center gap-3 text-sm text-surface-700 dark:text-surface-400 hover:text-primary-500 transition-colors">
                    <Phone size={16} className="text-primary-500 shrink-0" />
                    +91 9373955349
                  </a>
                  <div className="flex items-start gap-3 text-sm text-surface-700 dark:text-surface-400">
