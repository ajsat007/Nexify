          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {[
              ...
              <div key={i} className="text-center p-6 bg-neutral-50 rounded-2xl border border-neutral-200">
                ...
                <div className="text-xs text-neutral-800 mt-0.5">{s.sub}</div>
              </div>
            ))}
          </div>
                ...
                {projections.map((p, i) => (
                  <div key={i} className="bg-white rounded-xl p-4 border border-neutral-200">
                    ...
                    <div className="grid grid-cols-3 gap-2 text-center text-sm">
                      <div><div className="font-medium text-neutral-900">{p.revenue}</div><div className="text-xs text-neutral-800">Revenue</div></div>
                      <div><div className="font-medium text-neutral-900">{p.expenses}</div><div className="text-xs text-neutral-800">Costs</div></div>
                      <div><div className="font-medium text-success">{p.profit}</div><div className="text-xs text-neutral-800">Profit</div></div>
                    </div>
                  </div>
                ))}
              </div>
