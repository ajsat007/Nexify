    ...
    return (
      <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950 flex items-center justify-center p-4">
        <div className="max-w-md w-full text-center">
          ...
          <p className="text-neutral-500 mb-6">{bookingReplies[Math.floor(Math.random() * bookingReplies.length)]}</p>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex items-center justify-center gap-2 mb-12">
              {[1, 2, 3].map(s => (
                <div key={s} className="flex items-center gap-2">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold transition-all ${step >= s ? 'bg-primary-500 text-white' : 'bg-neutral-200 dark:bg-neutral-700 text-neutral-400 dark:text-neutral-500'}`}>{s}</div>
                  <span className={`text-xs hidden sm:inline ${step >= s ? 'text-primary-600 dark:text-primary-400 font-medium' : 'text-neutral-400'}`}>{s === 1 ? 'Service' : s === 2 ? 'Time' : 'Details'}</span>
            ...
            {step === 1 && (
              <div className="reveal space-y-6">
                ...
                <p className="text-neutral-500 text-center">Choose the option that best fits your needs</p>
            ...
            {step === 2 && (
              <div className="reveal space-y-6">
                ...
                <p className="text-neutral-500 text-center">{selected?.name}</p>
            ...
            {step === 3 && (
              <div className="reveal space-y-6 max-w-lg mx-auto">
                ...
                <p className="text-neutral-500 text-center">Share your details and I'll send the confirmation</p>
                ...
                <div className="bg-white dark:bg-neutral-800/50 rounded-2xl border border-neutral-200 dark:border-neutral-700 p-6 space-y-4">
                  <div className="flex items-center gap-4 p-3 bg-neutral-50 dark:bg-neutral-800 rounded-xl">
                    ...
                    <div><div className="text-sm font-medium">{selectedDate}</div><div className="text-xs text-neutral-400">{selectedTime}</div></div>
                  </div>
                  <div className="flex items-center gap-4 p-3 bg-neutral-50 dark:bg-neutral-800 rounded-xl">
                    <Zap className="w-5 h-5 text-primary-500" />
                    <div><div className="text-sm font-medium">{selected?.name}</div><div className="text-xs text-neutral-400">{selected?.desc}</div></div>
                  </div>
                </div>
                ...
                <p className="text-xs text-neutral-400 text-center">By booking, you agree to the terms. Your data is secure.</p>
              </div>
            )}
          </div>
        </div>
