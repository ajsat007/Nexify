      ...
      <section className="section-padding bg-white">
        <div className="section-container">
          <div className="text-center mb-16 reveal">
            ...
            <p className="text-neutral-500">8 channels managed by specialized AI marketing agents · Zero ad spend</p>
          </div>
      ...
      <section className="section-padding bg-neutral-50">
        <div className="section-container">
          <div className="text-center mb-12 reveal">
            ...
            <p className="text-neutral-500">AI-generated content pipeline · 8 weeks planned</p>
          </div>
          <div className="bg-white rounded-2xl border border-neutral-200 overflow-hidden reveal">
            <table className="w-full">
              <thead><tr className="border-b border-neutral-100 bg-neutral-50">
                <th className="text-left p-4 text-xs font-semibold text-neutral-400 uppercase">Week</th>
                <th className="text-left p-4 text-xs font-semibold text-neutral-400 uppercase">Topic</th>
                <th className="text-left p-4 text-xs font-semibold text-neutral-400 uppercase">Channel</th>
                <th className="text-left p-4 text-xs font-semibold text-neutral-400 uppercase">Type</th>
              </tr></thead>
              <tbody className="divide-y divide-neutral-100">
                {contentCalendar.map((c, i) => (
                  <tr key={i} className="hover:bg-neutral-50"><td className="p-4 text-sm text-neutral-500">{c.week}</td><td className="p-4 text-sm font-medium text-neutral-900">{c.topic}</td><td className="p-4 text-sm text-neutral-500">{c.channel}</td><td className="p-4"><span className="chip bg-accent-50 text-accent-600 text-xs">{c.type}</span></td></tr>
                ))}
              </tbody>
            </table>
          </div>
      ...
      <section className="section-padding bg-white">
        <div className="section-container">
          <div className="text-center mb-12 reveal">
            ...
            <p className="text-neutral-500">Zero-cost ad strategy · AI-optimized targeting</p>
          </div>
      ...
      <section className="section-padding bg-white">
        <div className="section-container">
          <div className="text-center mb-12 reveal">
            ...
            <p className="text-neutral-500">Daily AI-generated content · Automated engagement</p>
          </div>
          <div className="grid md:grid-cols-3 gap-6 reveal">
            {[
