      ...
      <section className="section-padding bg-neutral-50 dark:bg-neutral-900">
        <div className="section-container">
          <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-16">
            ...
            <p className="text-neutral-600 dark:text-neutral-400 text-sm sm:text-base">We&apos;re building the future of software development. Literally.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {perks.map((p, i) => (
              <AnimatedSection key={p.title} animation="fade-up" delay={i * 50}>
                <div className="text-center p-5 sm:p-6 bg-white dark:bg-neutral-800 rounded-2xl border border-neutral-200 dark:border-neutral-700 hover:border-primary-500/20 transition-all h-full">
      ...
      <section className="section-padding bg-white dark:bg-neutral-950">
        <div className="section-container">
          <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-12">
            ...
            <p className="text-neutral-600 dark:text-neutral-400 text-sm sm:text-base">We&apos;re looking for humans who want to build the future of AI-powered software.</p>
          </div>
          <div className="space-y-3 sm:space-y-4 max-w-3xl mx-auto">
            {positions.map((job, i) => (
              <AnimatedSection key={i} animation="fade-up" delay={i * 50}>
                <div className="bg-white dark:bg-neutral-800 rounded-xl p-5 sm:p-6 border border-neutral-200 dark:border-neutral-700 hover:border-primary-500/30 transition-all group">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
                    <div className="min-w-0">
                      ...
                      <div className="flex items-center gap-3 mt-1.5">
                        ...
                        <span className="text-xs sm:text-sm text-neutral-500 flex items-center gap-1"><MapPin size={12} /> {job.location}</span>
                      </div>
                      <p className="text-sm text-neutral-600 dark:text-neutral-400 mt-2 leading-relaxed">{job.desc}</p>
                    </div>
