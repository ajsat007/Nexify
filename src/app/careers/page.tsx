      ...
      <section className="section-padding bg-white">
        <div className="section-container">
          <div className="text-center max-w-3xl mx-auto mb-16 reveal">
            ...
            <p className="text-neutral-800">We're building the future of software development. Literally.</p>
          </div>
            ...
            {[
              ...
              return (
                <div key={i} className="text-center p-6 bg-neutral-50 rounded-2xl border border-neutral-200">
                  ...
                  <p className="text-sm text-neutral-800">{b.desc}</p>
                </div>
              )
            })}
          </div>
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 reveal">
            ...
            <p className="text-neutral-800">We're looking for humans who want to build the future of AI-powered software development.</p>
          </div>
              ...
              <div key={i} className="bg-neutral-50 rounded-xl p-6 border border-neutral-200 hover:border-primary-500/30 hover:bg-white transition-all group">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  <div>
                    ...
                    <div className="flex items-center gap-3 mt-1 text-sm text-neutral-800">
                      <span className="chip bg-primary-50 text-primary-600 text-xs">{job.type}</span>
                      <span>{job.location}</span>
                    </div>
                    <p className="text-sm text-neutral-800 mt-2">{job.desc}</p>
                  </div>
