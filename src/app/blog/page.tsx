          ...
          {showGenerator && (
            <div className="mb-12 bg-gradient-to-r from-accent-500/5 to-primary-500/5 rounded-2xl border border-accent-500/20 p-6 reveal">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div><h2 className="font-semibold">AI Blog Post Generator</h2><p className="text-xs text-neutral-400">Powered by Nexify AI agents — generates in seconds</p></div>
              </div>
              ...
              {generatedPost && (
                <div className="mt-6 bg-white rounded-xl border border-neutral-200 p-6 animate-slide-up">
                  ...
                  <div className="flex items-center gap-2 mt-4 pt-4 border-t border-neutral-100 text-xs text-neutral-400">
