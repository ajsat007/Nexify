...
export const searchData: SearchResult[] = [
  ...
  { title: 'Agent Marketplace', href: '/marketplace', category: 'Page', icon: 'Bot' },
  { title: 'Web Research Agent', href: '/marketplace/web-research-agent', category: 'Agent', icon: 'Cpu' },
  { title: 'Code Review Agent', href: '/marketplace/code-review-agent', category: 'Agent', icon: 'Code2' },
  { title: 'Customer Support Agent', href: '/marketplace/customer-support-agent', category: 'Agent', icon: 'Headphones' },
  { title: 'Data Analysis Agent', href: '/marketplace/data-analysis-agent', category: 'Agent', icon: 'BarChart3' },
  { title: 'PDF QA Agent', href: '/marketplace/pdf-qa-agent', category: 'Agent', icon: 'FileText' },
  { title: 'Sales Lead Qualification', href: '/marketplace/sales-lead-qualification', category: 'Agent', icon: 'TrendingUp' },
  { title: 'Multi-Agent Debate', href: '/marketplace/multi-agent-debate', category: 'Agent', icon: 'Layers' },
